...
#if UNITY_EDITOR
    [System.Serializable]
    class SendMessge : NetMessageConverter
    {
        #region 界面绘制
        ...
        public override string GetLuaScript()
        {
            ...
            luaCode.AppendLine("CS.Magic.GameEditor.NetMessageConvertPlan.Instance:SendFakeMessageToServer(BSMsgDefine." + this.messageType + ", data)");
